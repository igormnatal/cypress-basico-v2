describe('Central de Atendimento ao Cliente TAT', function(){
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function(){
        ...
        cy.get('#lastName')
            .type('Natal')
            .should('have.value', 'Natal')
            .clear()
            .should('have.value','')
        cy.get('#email')
            .type('igor.natal@hotmail.com')
            .should('have.value', 'igor.natal@hotmail.com')
            .clear()
            .should('have.value','')
        cy.get('#phone')
            .type('1234567890')
    ...
    it('erifica que a política de privacidade abre em outra aba sem a necessidade de um clique', function(){
